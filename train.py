...
def main():
    ...
    parser.add_argument('--l2reg', default=5e-4, type=float, help='Legacy non-BERT weight decay fallback.')
    ...
    parser.add_argument("--weight_decay", default=0.01, type=float, help="Weight decay for both non-BERT and BERT optimizers.")
    ...
    parser.add_argument('--sg_cl_weight', default=0.0, type=float, help='Weight for SG-MBSC sentiment contrastive loss.')
    parser.add_argument('--sg_branch_weight', default=0.05, type=float, help='Weight for SG-MBSC private branch supervision loss.')
    parser.add_argument('--sg_diversity_weight', default=0.0, type=float, help='Weight for SG-MBSC expert diversity regularization.')
    parser.add_argument('--sg_jepa_weight', default=0.0, type=float, help='Weight for JEPA latent prediction loss in SG-MBSC.')
    parser.add_argument('--sg_dropout', default=0.35, type=float, help='Dropout before SG-MBSC final classifier.')
