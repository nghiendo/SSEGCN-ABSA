...
def main():
    ...
    parser.add_argument('--sg_diversity_weight', default=0.1, type=float, help='Weight for SG-MBSC expert diversity regularization.')
    parser.add_argument('--sg_jepa_weight', default=0.15, type=float, help='Weight for JEPA latent prediction loss in SG-MBSC.')
