...
python ./train.py \
  ...
  --student_init_path ./state_dict/ssegcnbertstudent_laptop_acc_0.6820_f1_0.6339 \
  --aux_teacher_path ./state_dict/ssegcnbertstudent_laptop_acc_0.6820_f1_0.6339 \
  --aux_teacher_model_name ssegcnbertstudent \
  --aux_teacher_logit_weight 0.5 \
  --aux_teacher_blend_mode teacher_uncertainty \
